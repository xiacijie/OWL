...
bool TR_OWLJNIClient::startJVM(){
    ...
    if (!_isJvmRunning) {
        ...
        sprintf(classpath, "-Djava.class.path=%s/com.ibm.wala.util/build/classes/java/main:%s/com.ibm.wala.shrike/build/classes/java/main:%s/com.ibm.wala.core/build/classes/java/main:%s/com.ibm.wala.core/dat:%s/com.ibm.wala.cast/build/classes/java/main:/Users/dolby/WalaWorkspace/OWLLoader/target/classes/", walaHome, walaHome, walaHome, walaHome, walaHome);
